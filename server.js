    ...
    const command = ffmpeg(streamUrl)
        .inputOptions([
            ...
            // 1. වීඩියෝ ෆිල්ටර්ස්: පාට ලොකුවට වෙනස් කිරීම සහ w=380, h=85 කළු පෙට්ටියෙන් ලෝගෝ එක වැසීම
             '-vf', 'eq=saturation=2.65\\:contrast=1.90\\:brightness=0.08\\:gamma=1.3,drawbox=x=iw-w-15:y=10:w=380:h=85:color=black@0.9:t=fill,drawtext=text=\'SPORT CLUB\':x=iw-380+(380-text_w)/2:y=10+(85-text_h)/2:fontsize=32:fontcolor=red',
